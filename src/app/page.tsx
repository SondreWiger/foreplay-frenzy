...
type Screen = "home" | "players" | "limits" | "lobby" | "playing";
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <div className="text-center pt-8 sm:pt-12">
                ...
                >
                  ...
                  <p className="text-sm sm:text-lg text-white/40 max-w-md mx-auto px-2">
                    The ultimate kinky game suite. From teasing to depravity — how deep will you go?
                  </p>
                </motion.div>
              </div>
              ...
              >
                <Button
                  ...
                  variant="primary"
                  size="lg"
                  className="w-full text-base sm:text-lg py-4 min-h-[52px]"
                >
                  🎮 Start New Game
                </Button>
              ...
              >
                {[
                  { emoji: "🎲", title: "Dice Rolling", desc: "Random wild scenarios" },
                  { emoji: "🎭", title: "500+ Roleplays", desc: "Dirty scenarios" },
                  { emoji: "💋", title: "Truth or Dare", desc: "Abyss edition" },
                  { emoji: "⏱️", title: "Edging Timer", desc: "Orgasm control" },
                  { emoji: "🔒", title: "Limits System", desc: "200+ kinks" },
                  { emoji: "🛡️", title: "Safety First", desc: "Traffic light system" },
                ].map((feat) => (
                  <div
                    key={feat.title}
                    className="bg-blood-900/50 border border-blood-800/30 rounded-xl p-2.5 sm:p-3 text-center"
                  >
                    ...
                    <p className="text-[9px] sm:text-[10px] text-white/40 hidden sm:block">{feat.desc}</p>
                  </div>
                ))}
              </motion.div>

              <div className="text-center pt-4 sm:pt-8">
                <p className="text-xs text-white/20">v1.0 • Made with 🔥 & sin</p>
              </div>
            </motion.div>
          )}
          ...
          {session && session.phase === "paused" && (
            <motion.div
              ...
              className="text-center space-y-4 sm:space-y-6 pt-12 sm:pt-20"
            >
              ...
              <div className="space-y-3 max-w-xs mx-auto px-4">
                ...
                <Button
                  onClick={() => {
                    ...
                    useGameStore.getState().setShowAftercare(false);
                    setScreen("home");
                  }}
                  variant="ghost"
                  className="w-full min-h-[48px]"
          ...
          {session && session.phase === "ended" && (
            <motion.div
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-center space-y-4 sm:space-y-6 pt-8 sm:pt-12"
            >
              <motion.div
